...
|------------------|-------------| ------|
| `openrouter` | [OpenRouter](https://openrouter.ai/) | ️:white_check_mark: Supported |
| `openai` | [OpenAI](https://openai.com/) | :white_check_mark: Supported |
| `azurecredits` | [Azure OpenAI](https://azure.microsoft.com/en-gb/products/ai-foundry/models/openai/) | :warning: Not yet supported |
