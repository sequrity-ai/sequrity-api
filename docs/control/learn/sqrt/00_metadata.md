...
The persistency of the session metadata is controlled by [`FsmOverrides.clear_session_meta`][sequrity.control.types.headers.FsmOverrides]: `"never"`, `"every_attempt"`, or `"every_turn"`.
