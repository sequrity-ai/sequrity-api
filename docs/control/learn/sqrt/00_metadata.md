...
The persistency of the session metadata is controlled by [`FineGrainedConfigHeader.clear_session_meta`][sequrity.types.control.headers.FineGrainedConfigHeader.clear_session_meta]: `"never"`, `"every_attempt"`, or `"every_turn"`.
