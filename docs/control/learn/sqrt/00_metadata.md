...
The persistency of the session metadata is controlled by [`FsmOverrides.clear_session_meta`][sequrity.types.headers.FsmOverrides]: `"never"`, `"every_attempt"`, or `"every_turn"`.
