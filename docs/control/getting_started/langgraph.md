...
This tutorial demonstrates how to integrate [LangGraph](https://langchain-ai.github.io/langgraph/) with Sequrity's Control API using the [`langgraph.run`][sequrity.control.resources.langgraph.LangGraphResource.run] method. We'll build a SQL agent with conditional routing that showcases LangGraph's powerful workflow capabilities while maintaining security through Sequrity.
...
Sequrity's [`langgraph.run`][sequrity.control.resources.langgraph.LangGraphResource.run] method provides all of this out-of-the-box, allowing you to focus on building your workflow logic while Sequrity handles security.
